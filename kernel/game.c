...
DynamicFunctionMapping dynamicFunctionMappings[] = {
    {_coldArea, (void (*)(void *))enterColdArea, &FunctionEnterColdAreaParams},
    {_desert, (void (*)(void *))enterDesert, &FunctionEnterDesertParams},
    {_combatWithStranger, (void (*)(void *))combatWithStranger, &FunctionCombatWithStrangerParams},
    {_acquireImmunityAndDefuff, (void (*)(void *))acquireImmunityAndDebuff, &FunctionWithPlayerParamParams},
    ...
    {_increaseDamageRandomPercent, (void (*)(void *))increaseDamageRandomPercent, &FunctionWithPlayerParamParams},
    ...
    {_enterForest, (void (*)(void *))enterForest, &FunctionWithPlayerParamParams},
    {_powerOfHeaven, (void (*)(void *))powerOfHeaven, &FunctionWithPlayerParamParams},
    ...
    {_playerRest, (void (*)(void *))playerRest, &FunctionWithPlayerParamParams},
